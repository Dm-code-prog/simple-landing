    ...
    <Layout>
      <div className="privacy-container">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              this Agreement) refers to SIMPLE PROTOCOL TECHNOLOGIES LLC, 346-019,
              SCHON BUSINESS PARK, DIP-1, Dubai.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              as a mobile applications push notifications regarding updates or
        ...
        <p>
          ...
          Your parents consent before We collect and use that information.
        </p>
        <h1>Links to Other Websites</h1>
        <p>
          Our Service may contain links to other websites that are not operated by
          Us. If You click on a third party link, You will be directed to that third
          partys site. We strongly advise You to review the Privacy Policy of every
          site You visit.
        </p>
        <p>
